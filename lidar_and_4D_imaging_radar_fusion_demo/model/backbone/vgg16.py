...
# from torchvision.models.evaluator import load_state_dict_from_url
...
def decom_vgg16(pretrained = False):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url("https://download.pytorch.org/models/vgg16-397923af.pth", model_dir="./oxford_dataset")
