...
if __name__ == "__main__":
    ...
    box2d1 = np.array([0,0,3,3,0])
    box2d2 = np.array([1,1,2,2,np.pi/3])
    tensor1 = torch.FloatTensor(box2d1).unsqueeze(0).unsqueeze(0).cuda()
    tensor2 = torch.FloatTensor(box2d2).unsqueeze(0).unsqueeze(0).cuda()
